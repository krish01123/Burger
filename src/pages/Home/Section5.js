...
import { Container, Row, Col, Card, CardSubtitle, Carousel } from 'react-bootstrap';
    ...
    <section className="shop_section">
        <Container>
            <Row className="align-items-center">
                <Col lg={6} className="text-center text-lg-start mb-5 mbl-lg-0">
                <h4>Download mobile App and</h4>
                <h2>save up to 20%</h2>
                <p>
                    Get exclusive deals, faster ordering, and a smoother experience right at your fingertips.
                </p>
                <Link to="/">
                <img src={StoreIOS}
                 alt="IOS"
